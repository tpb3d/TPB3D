...
Stats::PosCalc ()
{
   ...
   mOtherFace->SetPosition (( pCam->GetCamSize ().x / 2) - 128, 16, 0); // relative based on clock
   mStatsFace->SetPosition (( pCam->GetCamSize ().x / 2) - 128, 32, 0); // relative based on clock
}
