...
SpecialPerson::SpecialPerson (Location& loc)
:  Person (loc)
{
}
SpecialPerson::~SpecialPerson (void)
{
}

void SpecialPerson::Update (int tod)   //actual time
{
   ...
   else if (mHome < 1 && mActivity == AS_Sleeping ) // in general, Special is sleepping, wake up and go to work.
   {
...
void SpecialPerson::Draw ()
{
//   Render (parameters );
}

void SpecialPerson::Draw (int vx, int vy)
{
