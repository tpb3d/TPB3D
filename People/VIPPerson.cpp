...
VIPPerson::VIPPerson (Location& loc)
:  Person (loc)
{
}
VIPPerson::~VIPPerson (void)
{
}

void VIPPerson::Update (int tod)   //actual time
{
   ...
   else if (mHome < 1 && mActivity == AS_Sleeping ) // in general, VIP is sleepping, wake up and go to work.
   {
...
void VIPPerson::Draw (int vx, int vy)
{
