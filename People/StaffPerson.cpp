...
#include "StaffPerson.h"

StaffPerson::StaffPerson (Location& loc)
:  Person (loc)
{
}
StaffPerson::~StaffPerson (void)
{
}

void StaffPerson::Update (int tod)   //actual time
{
   ...
   else if (mHome < 1 && mActivity == AS_Sleeping ) // in general, staff is sleepping, wake up and go to work.
   {
...
void StaffPerson::Draw ()
{
//   Render (parameters );
}

void StaffPerson::Draw (int vx, int vy)
{
