...
/** Always the top Pathway node. A document binds together all the
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	/** Get the root element -- the only top Pathway element -- of the document.
		In well formed XML, there should only be one. TinyXml is tolerant of
		multiple elements at the document Pathway.
	*/
